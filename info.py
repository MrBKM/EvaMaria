...
BOT_TOKEN = environ.get("BOT_TOKEN", "5809560597:AAGWkjhGYymEnYxDknm00yenrzCfYirdgBY")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '953377581 5702578360').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001822275183').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '953377581 5702578360').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
auth_channel = environ.get('AUTH_CHANNEL')
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = environ.get("AUTH_CHANNEL", "-1001506877410")
AUTH_GROUPS = environ.get("AUTH_GROUPS", "-1001510283128")
